...
See demo code in [AoikTopDownParserDemo](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo).

Tested working with:
- Python 2.7+, 3.2+

Inspired by [Yapps](https://github.com/mk-fg/yapps).

## Table of Contents
- [Features](#features)
  - [LL(n>=1)](#lln1)
  - [No separate lexer](#no-separate-lexer)
  - [No runtime dependency](#no-runtime-dependency)
  - [Simpler rules syntax](#simpler-rules-syntax)
  - [Simpler generated code](#simpler-generated-code)
  - [Embedded code](#embedded-code)
  - [Tweakable re.compile arguments](#tweakable-recompile-arguments)
  - [Tweakable generation options](#tweakable-generation-options)
  - [Handy debug information](#handy-debug-information)
- [Setup](#setup)
  - [Setup via pip](#setup-via-pip)
  - [Setup via git](#setup-via-git)
  - [Find entry program](#find-entry-program)
- [Setup of AoikTopDownParserDemo](#setup-of-aoiktopdownparserdemo)
- [Usage](#usage)
  - [Show help](#show-help)
  - [Show version](#show-version)
  - [Specify rules data by file path](#specify-rules-data-by-file-path)
  - [Specify rules data by object URI](#specify-rules-data-by-object-uri)
  - [Specify generated parser file path](#specify-generated-parser-file-path)
  - [Specify source data by file path](#specify-source-data-by-file-path)
  - [Specify source data by object URI](#specify-source-data-by-object-uri)
  - [Specify generation options](#specify-generation-options)
    - [Specify doc opts](#specify-doc-opts)
    - [Specify ext opts](#specify-ext-opts)
    - [Specify file content as option value](#specify-file-content-as-option-value)
    - [Specify parser template](#specify-parser-template)
    - [Specify parser template's variable substitution](#specify-parser-templates-variable-substitution)
  - [Specify parser's debug message on/off](#specify-parsers-debug-message-onoff)
    - [Specify rules parser's debug message on/off](#specify-rules-parsers-debug-message-onoff)
    - [Specify generated parser's debug message on/off](#specify-generated-parsers-debug-message-onoff)
  - [Specify program's debug message on/off](#specify-programs-debug-message-onoff)
  - [Run generated parser](#run-generated-parser)
  - [Generate AoikTopDownParser's rules parser](#generate-aoiktopdownparsers-rules-parser)

## Features
AoikTopDownParser is inspired by [Yapps](https://github.com/mk-fg/yapps).
...
Take the rules of the [Calculator](http://theory.stanford.edu/~amitp/yapps/yapps2/manual/node2.html#SECTION00023000000000000000) from Yapps's doc for
 example.
...
- [Yapps' yapps.runtime module](https://github.com/mk-fg/yapps/blob/master/yapps/runtime.py)
- [AoikTopDownParser's mechanism code](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/parser.py)
   (lines 1 to 437).
...
For a rule that contains merely a sequence of sub-rules, code generated by
 ...
 example:
 - [Code generated by Yapps](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/parser_yapps.py#L21)
 - [Code generated by AoikTopDownParser](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/parser.py#L450)
...
For a rule that contains branching caused by `| ? * +`, code generated by
 ...
 example:
 - [Code generated by Yapps](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/parser_yapps.py#L27)
 - [Code generated by AoikTopDownParser](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/parser.py#L457)
...
A rule function call is passed in a "context argument" named "_ctx". (The
 ...
 [GS_CTX_VAR](/src/aoiktopdownparser/gen/opts_const.py#L42).) After the call is
...
Embedded code can store custom result in this context argument. It is an
 [AttrDict](/src/aoiktopdownparser/parser.py#L16) object, which means it's
...
A terminal rule's custom result is the match object returned by **re.match**.
 ...
 [SS_CTX_K_REM](/src/aoiktopdownparser/gen/opts_const.py#L128).)
...
Demo code has been put in a separate repo
 [AoikTopDownParserDemo](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo#setup).
...
- [GS_VER](/src/aoiktopdownparser/gen/opts_const.py#L11):
   rules parser version.
- [GS_TPLT](/src/aoiktopdownparser/gen/opts_const.py#L14):
   parser template file path.
- [GS_REO_PRF](/src/aoiktopdownparser/gen/opts_const.py#L19):
   re object's name prefix.
- [GS_REO_POF](/src/aoiktopdownparser/gen/opts_const.py#L24):
   re object's name postfix.
- [GS_FUNC_PRF](/src/aoiktopdownparser/gen/opts_const.py#L32):
   rule function's name prefix.
- [GS_FUNC_POF](/src/aoiktopdownparser/gen/opts_const.py#L37):
   rule function's name postfix.
- [GS_CTX_VAR](/src/aoiktopdownparser/gen/opts_const.py#L42):
   rule function's context argument's name.
- [GS_RES_VAR](/src/aoiktopdownparser/gen/opts_const.py#L47):
   result variable name of scanning a rule.
- [GS_REP_VAR](/src/aoiktopdownparser/gen/opts_const.py#L53):
   result variable name of scanning a non-rule re pattern.
- [GS_CODE_PRF](/src/aoiktopdownparser/gen/opts_const.py#L60):
   code before embedded code.
- [GS_CODE_POF](/src/aoiktopdownparser/gen/opts_const.py#L66):
   code after embedded code.
- [GS_ENTRY](/src/aoiktopdownparser/gen/opts_const.py#L71):
   entry rule name.
- [SS_PSR_CLS_NAME](/src/aoiktopdownparser/gen/opts_const.py#L114):
   parser class name.
- [SS_WS_REP](/src/aoiktopdownparser/gen/opts_const.py#L119):
   re pattern for white spaces.
- [SS_CTX_K_NAME](/src/aoiktopdownparser/gen/opts_const.py#L122):
   context dict's key name for rule name.
- [SS_CTX_K_PAR](/src/aoiktopdownparser/gen/opts_const.py#L125):
   context dict's key name for parent context dict.
- [SS_CTX_K_REM](/src/aoiktopdownparser/gen/opts_const.py#L128):
   context dict's key name for re match result.
- [SS_FILE_PRF](/src/aoiktopdownparser/gen/opts_const.py#L131):
   code at top of the file.
- [SS_FILE_POF](/src/aoiktopdownparser/gen/opts_const.py#L134):
   code at end of the file.
- [SS_IMPORTS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L137):
   code before import statements.
- [SS_IMPORTS_POF](/src/aoiktopdownparser/gen/opts_const.py#L140):
   code after import statements.
- [SS_RULE_FUNCS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L143):
   code before rule funcs' code.
- [SS_RULE_FUNCS_POF](/src/aoiktopdownparser/gen/opts_const.py#L146):
   code after rule funcs' code.
- [SS_INIT_FUNC_PARGS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L149):
   code before parser class' init function's positional arguments.
- [SS_INIT_FUNC_PARGS_POF](/src/aoiktopdownparser/gen/opts_const.py#L152):
   code after parser class' init function's positional arguments.
- [SS_INIT_FUNC_KARGS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L155):
   code before parser class' init function's keyword arguments.
- [SS_INIT_FUNC_KARGS_POF](/src/aoiktopdownparser/gen/opts_const.py#L158):
   code after parser class' init function's keyword arguments.
- [SS_INIT_FUNC_END](/src/aoiktopdownparser/gen/opts_const.py#L161):
   code at end of the parser class' init function.
- [SS_INIT_CALL_PARGS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L164):
   code before parser object init call's positional arguments in parse function.
- [SS_INIT_CALL_PARGS_POF](/src/aoiktopdownparser/gen/opts_const.py#L167):
   code after parser object init call's positional arguments in parse function.
- [SS_INIT_CALL_KARGS_PRF](/src/aoiktopdownparser/gen/opts_const.py#L170):
   code before parser object init call's keyword arguments in parse function.
- [SS_INIT_CALL_KARGS_POF](/src/aoiktopdownparser/gen/opts_const.py#L173):
   code after parser object init call's keyword arguments in parse function.
- [SS_PARSE_FUNC_END](/src/aoiktopdownparser/gen/opts_const.py#L176):
...
If you want to use a file's content as option value, there are several
 ...
 - [aoiktopdownparser.gen.opts_util.p](/src/aoiktopdownparser/gen/opts_util.py#L32)
   marks the option value as file path. Either absolute, or relative to dir of
    the current file. See [here](/src/aoiktopdownparser/gen/me/opts.py#L49)
    for example.
 - [aoiktopdownparser.gen.opts_util.rr](/src/aoiktopdownparser/gen/opts_util.py#L85)
   marks the option value as file path, relative to AoikTopDownParser's
    **src/aoiktopdownparser** dir. See [here](/src/aoiktopdownparser/gen/opts.py#L32)
    for example.
 - [aoiktopdownparser.gen.opts_util.v](/src/aoiktopdownparser/gen/opts_util.py#L23)
...
Default template is [src/gen/parser_tplt.py](/src/aoiktopdownparser/gen/parser_tplt.py).

Use generation option [GS_TPLT](/src/aoiktopdownparser/gen/opts_const.py#L14) to
 specify a custom one. See [here](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/opts.py#L16)
 for example.
...
Variables in parser template are defined using syntax `{SS_VAR_NAME}` where
 ...
 `SS_PSR_CLS_NAME` in [parser_tplt.py](/src/aoiktopdownparser/gen/parser_tplt.py#L48).
...
If generation option [SS_FILE_POF](/src/aoiktopdownparser/gen/opts_const.py#L134)
 has been specified to use file [main_func_tplt.py](/src/aoiktopdownparser/gen/main_func_tplt.py)'s
...
```
- `opts.py` specifies **SS_FILE_POF** [here](https://github.com/AoiKuiyuyou/AoikTopDownParserDemo/blob/0.1/src/aoiktopdownparserdemo/calc/opts.py#L22).
...
AoikTopDownParser's rules parser file [parser.py](/src/aoiktopdownparser/parser.py)
 is generated by
```
